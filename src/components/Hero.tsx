      ...
      <div className="relative mx-auto flex max-w-6xl flex-col px-4 pb-20 pt-28 sm:px-6 md:pt-32 lg:flex-row lg:items-center lg:gap-12 lg:px-8 lg:pb-28">
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.99 }}
            className="group relative block overflow-hidden rounded-[26px] border border-sky-400/20 bg-gradient-to-r from-slate-950 via-[#101a32] to-[#13274b] p-[1px] text-left shadow-[0_24px_70px_rgba(37,99,235,0.18)] transition"
          >
            ...
            <div className="relative rounded-[25px] bg-slate-950/90 px-4 py-4 sm:px-5">
              ...
              <div className="mt-3 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="inline-flex items-center gap-2 self-start rounded-full border border-sky-300/20 bg-white/8 px-4 py-2 text-sm font-medium text-white transition group-hover:border-sky-300/40 group-hover:bg-white/12 sm:self-center">
